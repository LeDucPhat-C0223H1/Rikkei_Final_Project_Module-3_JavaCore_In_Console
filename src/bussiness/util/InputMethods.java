...
public final class InputMethods {
    ...
    private static final String ERROR_POSITIVEINTERGER = "===>> Bạn phải nhập số nguyên dương";
    /*========================================Input Method Start========================================*/
    ...
    public static int getPositiveInteger() {
        while (true) {
            ...
            if (num > 0) {
                ...
                System.err.println(ERROR_POSITIVEINTERGER);
            }
        }
    }

    public static boolean checkInteger(String[] arrayWords) {
